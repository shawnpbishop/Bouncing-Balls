...
class Ball:
    def __init__(self):
        self.x = 200 # Starting center position
        self.y = 150 # Starting y coordinate
        self.dx = 0 # Move right by default
...
class BounceBalls:
    def __init__(self):
        ...
        self.width = 400 # Width of the self.canvas
        self.height = 300 # Width of the self.canvas
    ...
    def redisplayBall(self, ball):
        ...
        if ball.y > self.height-5 or ball.y < 5: #have the ball change direction before it hits wall
            ball.dy = -ball.dy
